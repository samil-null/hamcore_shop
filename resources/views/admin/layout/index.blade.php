...
<head>
  ...
  <link type="text/css" href="/admin/assets/css/custom.css?v=1.0.0" rel="stylesheet">
</head>
...
<body>
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0" href="/admin/index.html">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('admin.category')}}">
              <i class="ni ni-planet text-blue"></i> Категории
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/admin/examples/profile.html">
              <i class="ni ni-single-02 text-yellow"></i> Пользователи
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="/admin/examples/tables.html">
              <i class="ni ni-bullet-list-67 text-red"></i> Заказы
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/admin/examples/login.html">
              <i class="ni ni-key-25 text-info"></i> Login
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/admin/examples/register.html">
  ...
  <div class="main-content">
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  <img alt="Image placeholder" src="/admin/assets/img/theme/team-4-800x800.jpg">
                </span>
    ...
    <div class="container-fluid mt--7">
      <div class="card shadow">
            <div class="card-header bg-transparent wrap-content-tiitle">
  ...
  <script src="/admin/assets/js/custom.js?v=1.0.0"></script>
</body>
